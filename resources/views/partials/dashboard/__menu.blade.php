            ...
            <ul role="list" class="-mx-2 space-y-2">
                ...
                <li>
                    <a href="{{ route('dashboard.members.index') }}"
                        class="group flex gap-x-2 rounded-md p-2 text-sm leading-6 hover:bg-gray-100 {{ request()->routeIs('dashboard.members.*') ? 'bg-sky-100 text-sky-500 font-semibold' : 'text-slate-900 font-medium' }}">
