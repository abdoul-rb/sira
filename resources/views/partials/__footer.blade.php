    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-20">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8">
                ...
                <p class="text-balance text-sm/6 text-gray-600">
                    Outil de gestion pour les commerçants africains
                </p>
            ...
            <div class="lg:col-span-2 md:grid md:grid-cols-3 md:gap-8">
                <div>
        ...
        <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
            <p class="text-sm/6 text-gray-600">
                &copy; {{ date('Y') }} {{ config('app.name') }}. Tous droits reservés.
            </p>
        </div>
    </div>
    </footer>