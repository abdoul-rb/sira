<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-16 text-center lg:pt-20 overflow-hidden">
    ...
    <div class="mt-10 lg:flex lg:justify-center lg:gap-x-4 space-y-3 lg:space-y-0">
        <a href="{{ route('auth.login') }}"
            class="w-full lg:w-auto group inline-flex items-center justify-center rounded-full py-2 px-5 text-sm font-semibold focus-visible:outline-2 focus-visible:outline-offset-2 bg-slate-900 text-white hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900">
            Créer un compte gratuitement
        </a>
        <a href="/features"
            class="w-full lg:w-auto group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm ring-slate-200 text-slate-700 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300">
            ...
            <span class="ml-3">{{ __('Découvrir les fonctionnalités') }}</span>
        </a>
    </div>

    <div
        class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 text-sm text-muted-foreground animate-fade-in-up animation-delay-400">
        @foreach (["Aucun engagement", "Prise en main immédiate", "Boutique physique"] as $feature)
        ...
        <ul role="list"
            ...
            <li>
                <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                    ...
                    <li class="flex">
                        <img alt="Tuple" loading="lazy" width="105" height="48" decoding="async" data-nimg="1"
                            style="color:transparent"
                            src="https://salient.tailwindui.com/_next/static/media/tuple.74eb0ae0.svg">
                    </li>
                    <li class="flex">
                        <img alt="StaticKit" loading="lazy" width="127" height="48" decoding="async" data-nimg="1"
                            style="color:transparent"
            ...
            <li>
                <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                    <li class="flex">
                        <img alt="Mirage" loading="lazy" width="138" height="48" decoding="async" data-nimg="1"
                            style="color:transparent"
                            src="https://salient.tailwindui.com/_next/static/media/mirage.18d2ec4e.svg">
                    </li>
                    <li class="flex">
                        <img alt="Laravel" loading="lazy" width="136" height="48" decoding="async" data-nimg="1"
                            style="color:transparent"
                            src="https://salient.tailwindui.com/_next/static/media/laravel.7deed17e.svg">
                    </li>
                    <li class="flex">
                        <img alt="Statamic" loading="lazy" width="147" height="48" decoding="async" data-nimg="1"
                            style="color:transparent"
