...
<div class="space-y-6" x-data="{
    ...
    <div class="flex items-center justify-between gap-2">
        ...
        <x-ui.btn.primary @click="$dispatch('open-modal', { id: 'create-supplier' })">
            {{ __('Ajouter un fournisseur') }}
        </x-ui.btn.primary>
    </div>

    <p class="text-sm overflow-hidden break-words text-gray-500 mt-1">
        Gérez les fournisseurs de vos produits.
    </p>
    ...
    <div class="mt-6 overflow-hidden border border-gray-200 rounded-lg shadow-2xs">
                                ...
                                <td class="py-5 px-4 lg:px-0">
                                    <div class="flex gap-x-6">
                                        ...
                                        <div class="flex-auto">
                                            ...
                                            <div class="text-xs/5 text-gray-500">{{ $supplier->email }}</div>
                                        </div>
                                    </div>
                                </td>
        ...
        <livewire:dashboard.settings.suppliers.edit />
    </div>
</div>
