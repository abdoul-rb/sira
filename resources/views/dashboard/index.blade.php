...
@section('content')
    <div>
        ...
        <div class="mt-6 grid grid-cols-6 lg:grid-cols-6 gap-2">
            <x-ui.cards.trending-stat-big class="col-span-full md:col-span-3" mainLabel="Trésorerie Actuelle"
            ...
            <x-ui.cards.trending-stat-big class="col-span-full md:col-span-3" mainLabel="Total des ventes (CA)"
            ...
            <x-ui.cards.trending-stat class="col-span-2" label="Nombre de commandes" :value="$totalOrders">
                <x-slot:icon>
            ...
            <x-ui.cards.trending-stat class="col-span-2" label="Clients" :value="$customersCount">
                <x-slot:icon>
                    <svg class="size-5 text-blue-500" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor"
                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <x-ui.cards.trending-stat class="col-span-2" label="Produits en stock" :value="$productsCount">
                <x-slot:icon>
