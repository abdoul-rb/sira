<x-ui.modals.base id="edit-product" size="xl">
    <x-slot:title>
        {{ __('Modifier le produit') }}
    </x-slot:title>

    <form wire:submit.prevent="update" class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <label for="image-upload-edit"
                            ...
                            <div class="text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    stroke-linejoin="round" class="w-6 h-6 text-gray-400 mx-auto mb-2">
        ...
        <div class="col-span-full flex justify-between gap-3 pt-2">
            <button type="button" @click="$dispatch('close-modal', { id: 'edit-product' })"
