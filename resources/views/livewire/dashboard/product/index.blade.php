<div class="space-y-6" x-data="{
    ...
    <div class="mx-auto max-w-2xl sm:max-w-none lg:max-w-7xl">
        ...
        <div
            class="relative inline-flex items-center justify-center w-full max-w-sm py-2 px-4 grid-cols-2 bg-gray-100 border border-gray-200 rounded-lg select-none">
            <button type="button"
                class="relative z-20 inline-flex items-center justify-center w-full py-1.5 px-2 transition-all rounded-md cursor-pointer whitespace-nowrap"
