<nav class="fixed lg:hidden w-full bottom-0 left-0 bg-white border-t border-gray-100 z-40">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        <x-ui.mobile-link label="Home" :route="route('dashboard.index')"
        ...
        <x-ui.mobile-link label="Dépenses" :route="route('dashboard.settings.expenses.index')"
            :active="request()->routeIs('dashboard.settings.expenses.*')">
            <svg class="w-4 h-4" data-slot="icon" fill="none" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <x-ui.mobile-link label="Ventes" :route="route('dashboard.orders.index')"
        ...
        <x-ui.mobile-link label="Clients" :route="route('dashboard.customers.index')"
            :active="request()->routeIs('dashboard.customers.*')">
            <svg class="w-4 h-4" data-slot="icon" fill="none" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round"
