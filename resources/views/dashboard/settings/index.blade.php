                    ...
                    <div class="mt-3 lg:mt-8 max-w-3xl">
                        <form wire:submit.prevent="update" class="grid grid-cols-1 lg:grid-cols-6 gap-4" novalidate>
                            ...
                            <div class="lg:col-span-3">
                                <div class="relative">
                                    <input type="file" accept="image/*" wire:model="featured_image" class="hidden"
                                        id="logo">
                                    <label for="logo"
                            ...
                            <x-form.input class="lg:col-span-4" name="name" label="Nom" :wire="true"
                            ...
                            <x-form.input class="lg:col-span-3" name="phoneNumber" label="Téléphone" :wire="true"
