...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'paymentStatus' => 'required|in:cash,mobile-money,credit',
    ...
    {
        return [
            'customerId.required' => __('Le client est requis.'),
            'customerId.exists' => __("Le client n'existe pas."),
            'warehouseId.exists' => __("L'entrepôt n'existe pas."),
            'status.required' => __('Le statut est requis.'),
            'status.in' => __('Le statut doit être une des valeurs suivantes : :values.'),
            'paymentStatus.required' => __('Le mode de paiement est requis.'),
            'paymentStatus.in' => __('Le mode de paiement doit être une des valeurs suivantes : :values.'),
