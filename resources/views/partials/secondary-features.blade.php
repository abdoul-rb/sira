        ...
        <div class="-mx-4 mt-20 flex flex-col gap-y-10 overflow-hidden px-4 sm:-mx-6 sm:px-6 lg:hidden">
            <div>
                <div class="mx-auto max-w-2xl">
                    <div class="w-9 rounded-lg bg-blue-600">
                        <svg aria-hidden="true" class="h-9 w-9" fill="none">
                            <defs>
                                <linearGradient id="_R_2meavb_" x1="11.5" y1="18" x2="36"
                                    y2="15.5" gradientUnits="userSpaceOnUse">
                                    <stop offset=".194" stop-color="#fff"></stop>
                                    <stop offset="1" stop-color="#6692F1"></stop>
                                </linearGradient>
                            </defs>
                            <path d="m30 15-4 5-4-11-4 18-4-11-4 7-4-5" stroke="url(#_R_2meavb_)" stroke-width="2"
                ...
                <div class="relative mt-10 pb-10">
                    <div class="absolute -inset-x-4 top-8 bottom-0 bg-slate-200 sm:-inset-x-6">
                    </div>

                    <div
                        class="relative mx-auto w-211 overflow-hidden rounded-xl bg-white shadow-lg ring-1 shadow-slate-900/5 ring-slate-500/10">
            ...
            <div class="grid grid-cols-3 gap-x-8" role="tablist" aria-orientation="horizontal">
                <div class="relative">
                    <div class="w-9 rounded-lg bg-blue-600">
                        <svg aria-hidden="true" class="h-9 w-9" fill="none">
                            <defs>
                                <linearGradient id="_R_areavb_" x1="11.5" y1="18" x2="36"
                                    y2="15.5" gradientUnits="userSpaceOnUse">
                                    <stop offset=".194" stop-color="#fff"></stop>
                                    <stop offset="1" stop-color="#6692F1"></stop>
                                </linearGradient>
                            </defs>
                            <path d="m30 15-4 5-4-11-4 18-4-11-4 7-4-5" stroke="url(#_R_areavb_)" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                    </div>
                    ...
                    <h3 class="mt-6 text-sm font-medium text-blue-600">
                        <button class="data-selected:not-data-focus:outline-hidden"
                            id="headlessui-tabs-tab-_R_ireavb_" role="tab" type="button" aria-selected="true"
                ...
                <div class="relative opacity-75 hover:opacity-100">
                    ...
                    <h3 class="mt-6 text-sm font-medium text-slate-600">
                        <button class="data-selected:not-data-focus:outline-hidden"
                            id="headlessui-tabs-tab-_R_mreavb_" role="tab" type="button" aria-selected="false"
                            tabindex="-1" data-headlessui-state=""
                            aria-controls="headlessui-tabs-panel-_R_rbeavb_"><span class="absolute inset-0"></span>
                            Contacts
                        </button>
                    </h3>
            ...
            <div class="relative mt-20 overflow-hidden rounded-4xl bg-slate-200 px-14 py-16 xl:px-16">
                <div class="-mx-5 flex">
                    <div class="px-5 transition duration-500 ease-in-out data-selected:not-data-focus:outline-hidden"
                        style="transform:translateX(-0%)" aria-hidden="false" id="headlessui-tabs-panel-_R_bbeavb_"
                        role="tabpanel" tabindex="0" data-headlessui-state="selected" data-selected=""
                        aria-labelledby="headlessui-tabs-tab-_R_ireavb_">
                        <div
                            class="w-211 overflow-hidden rounded-xl bg-white shadow-lg ring-1 shadow-slate-900/5 ring-slate-500/10">
                    ...
                    <div class="px-5 transition duration-500 ease-in-out data-selected:not-data-focus:outline-hidden opacity-60"
                        style="transform:translateX(-0%)" aria-hidden="true" id="headlessui-tabs-panel-_R_jbeavb_"
                        role="tabpanel" tabindex="-1" data-headlessui-state=""
                        aria-labelledby="headlessui-tabs-tab-_R_kreavb_">
                        <div
                            class="w-211 overflow-hidden rounded-xl bg-white shadow-lg ring-1 shadow-slate-900/5 ring-slate-500/10">
                            <img alt="" loading="lazy" width="1688" height="856" decoding="async"
                                data-nimg="1" class="w-full" style="color:transparent" sizes="52.75rem"
                    ...
                    <div class="px-5 transition duration-500 ease-in-out data-selected:not-data-focus:outline-hidden opacity-60"
                        style="transform:translateX(-0%)" aria-hidden="true" id="headlessui-tabs-panel-_R_rbeavb_"
                        role="tabpanel" tabindex="-1" data-headlessui-state=""
                        aria-labelledby="headlessui-tabs-tab-_R_mreavb_">
                        <div
                            class="w-211 overflow-hidden rounded-xl bg-white shadow-lg ring-1 shadow-slate-900/5 ring-slate-500/10">
                            <img alt="" loading="lazy" width="1688" height="856" decoding="async"
                                data-nimg="1" class="w-full" style="color:transparent" sizes="52.75rem"
                ...
                <div class="pointer-events-none absolute inset-0 rounded-4xl ring-1 ring-slate-900/10 ring-inset">
                </div>
            </div>
        </div>
    </div>
