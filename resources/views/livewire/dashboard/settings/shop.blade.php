...
<div class="space-y-6" x-data="{
    ...
    <div class="space-y-2">
        ...
        <div class="flex justify-center gap-4">
            @if ($tenant->shop && $tenant->shop->instagram_url)
                <a href="{{ $tenant->shop->instagram_url }}" target="_blank" rel="noopener noreferrer"
            ...
            @if ($tenant->shop && $tenant->shop->facebook_url)
                <a href="{{ $tenant->shop->facebook_url }}" target="_blank" rel="noopener noreferrer"
                    class="p-3 rounded-full border border-gray-200 hover:border-black transition-all duration-300 hover:scale-105">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="w-5 h-5 text-gray-600 hover:text-black">
