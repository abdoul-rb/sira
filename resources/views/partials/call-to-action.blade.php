<section id="get-started-today" class="relative overflow-hidden bg-blue-600 py-32">
    <img alt="" loading="lazy" width="2347" height="1244" decoding="async" data-nimg="1"
        class="absolute top-1/2 left-1/2 max-w-none -translate-x-1/2 -translate-y-1/2" style="color:transparent"
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        <div class="mx-auto max-w-lg text-center">
            ...
            <p class="mt-4 text-lg tracking-tight text-white">
                ...
                software so you can feel like you’re doing something productive.
            </p>
